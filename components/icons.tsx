...
export const TextIcon = ({ className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className={className || "w-4 h-4"} {...props}>
        <path d="M3.25 2.75a.75.75 0 0 0-1.5 0v10.5a.75.75 0 0 0 1.5 0v-4h3.5v4a.75.75 0 0 0 1.5 0v-10.5a.75.75 0 0 0-1.5 0v4h-3.5v-4ZM14.25 3h-4.5a.75.75 0 0 0 0 1.5h1.375v7.25h-1.375a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5h-1.375V4.5h1.375a.75.75 0 0 0 0-1.5Z" />
    </svg>
);

export const HashtagIcon = ({ className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className={className || "w-4 h-4"} {...props}>
        <path d="M6.339 3.324a.75.75 0 0 0-1.49-.153L3.29 9.75H2a.75.75 0 0 0 0 1.5h1.618l-.558 3.576a.75.75 0 0 0 1.49.153l.558-3.576h3.213l-.558 3.576a.75.75 0 0 0 1.49.153l.558-3.576h1.882a.75.75 0 0 0 0-1.5H9.661l.558-3.576a.75.75 0 0 0-1.49-.153L8.17 9.75H4.958l.558-3.576a.75.75 0 0 0-.17-.75Zm.823 6.426.558-3.576h3.213l-.558 3.576H7.162Z" />
    </svg>
);

export const CalculatorIcon = ({ className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm0 3h.008v.008H8.25v-.008Zm3-6h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm0 3h.008v.008H11.25v-.008Zm3-6h.008v.008H14.25v-.008Zm0 3h.008v.008H14.25v-.008ZM5.25 21a3 3 0 0 0 3-3V6a3 3 0 0 0-3-3H5.25a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3Z" />
    </svg>
);
...
export const ExpandIcon = ({ className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M20.25 20.25v-4.5m0 4.5h-4.5m4.5 0L15 15m-6 0-3.75 3.75M9 9l3.75-3.75M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9" />
    </svg>
);
